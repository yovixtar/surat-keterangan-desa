...
<div class="page-inner">
						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<input type="text" name="domisili" class="form-control" placeholder="Alamat / Domisili Anda...">
								</div>
								<div class="form-group">
									<label>Tahun Tinggal</label>
									<input type="number" name="tahun_tinggal" class="form-control" placeholder="Sejak tahun berapa anda tinggal...">
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
	...
	if (isset($_POST['kirim'])) {
		...
		$tahun_tinggal = $_POST['tahun_tinggal'];
		// $keperluan = $_POST['keperluan'];
		$nama_ktp = isset($_FILES['ktp']);
		$file_ktp = $_POST['nik'] . "_" . ".jpg";
		$nama_kk = isset($_FILES['kk']);
		$file_kk = $_POST['nik'] . "_" . ".jpg";
		$sql = "INSERT INTO data_request_skd (nik,scan_ktp,scan_kk,domisili,tahun_tinggal) VALUES ('$nik','$file_ktp','$file_kk', '$domisili', '$tahun_tinggal')";
