...
if ($hak_akses == "Pemohon") {
	$cek_data = "SELECT * FROM data_user WHERE nik=$nik";
	$query = mysqli_query($konek, $cek_data);
...
?>
	...
	<div class="page-inner">
		<div class="row mt-2">
			<?php if ($biodata_kosong) : ?>
				<div class="alert alert-warning mx-auto" role="alert">
					<strong>Perhatian!</strong> Biodata Anda belum lengkap. Silakan lengkapi biodata Anda terlebih dahulu sebelum melakukan permohonan surat.
				</div>
			<?php else : ?>
				...
				<div class="col-md-3 pr-md-0">
					<div class="card-pricing2 card-success">
						...
						<a href="?halaman=request_sku" class="btn btn-success btn-round btn-sm mb-3"><span class="btn-label">
								<i class="fas fa-plus-circle"></i> Buat Permohonan</a>
					</div>
				</div>
				<div class="col-md-3 pr-md-0">
