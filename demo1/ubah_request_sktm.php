						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
									...
									<img src="../dataFoto/scan_ktp/<?= $ktp; ?>" width="200" height="100" alt="" data-toggle="modal" data-target="#imageModal" onclick="setImageModalSrc('../dataFoto/scan_ktp/<?= $ktp; ?>')">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<img src="../dataFoto/scan_kk/<?= $kk; ?>" width="200" height="100" alt="" data-toggle="modal" data-target="#imageModal" onclick="setImageModalSrc('../dataFoto/scan_kk/<?= $kk; ?>')">
								</div>
								<div class="form-group">
...
<!-- Modal -->
<div class="modal modalfade" id="imageModal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true" style="width: 100%;">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<img id="imageModalSrc" src="" class="img-fluid" alt="Perbesar gambar">
			</div>
		</div>
	</div>
</div>
...
<!-- Required meta tags and other scripts -->
