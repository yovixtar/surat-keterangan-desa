						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<input type="text" name="lokasi" class="form-control" placeholder="Lokasi usaha Anda.." autofocus>
								</div>
								<div class="form-group">
									<label>Lama Usaha (Bulan)</label>
									<input type="number" name="lama-usaha" class="form-control" placeholder="Berapa bulan usaha Anda telah berjalan dalam bulan.." autofocus>
								</div>
								<div class="form-group">
									<label>Keterangan Tambahan</label>
									<input type="text" name="keperluan" class="form-control" placeholder="Keperluan / Keterangan Tambahan Anda.." autofocus>
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
...
if (isset($_POST['kirim'])) {
	...
	$sql = "INSERT INTO data_request_sku (nik,scan_ktp,scan_kk,usaha,keperluan,lokasi,lama_usaha) VALUES ('$nik','$file_ktp','$file_kk','$usaha','$keperluan','$lokasi','$lama_usaha')";
