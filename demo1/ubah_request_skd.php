						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<input type="text" name="domisili" class="form-control" value="<?= $domisili; ?>">
								</div>
								<div class="form-group">
									<label>Tahun Tinggal</label>
									<input type="number" name="tahun_tinggal" class="form-control" value="<?= $tahun_tinggal; ?>">
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
...
if (isset($_POST['ubah'])) {
	...
	$sql = "UPDATE data_request_skd SET scan_ktp='$file_ktp',scan_kk='$file_kk',domisili='$domisili',tahun_tinggal='$tahun_tinggal' WHERE id_request_skd=$id";
